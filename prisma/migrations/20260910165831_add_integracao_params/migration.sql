...
('deposito.systextil.ecommerce', '34', 'systextil', 'estoque', 'Depósito e-commerce (Systêxtil) = 034 PRODUTOS E-COMMERCE - fonte de verdade do estoque (vazio POR DESIGN; saldo entra por transferência manual)', TRUE, CURRENT_TIMESTAMP),
